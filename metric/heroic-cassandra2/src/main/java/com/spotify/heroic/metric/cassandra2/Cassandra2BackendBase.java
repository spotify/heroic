 ...
 *
 * The keyspace should be accessed using the {@link Cassandra2BackendBase#keyspace} method.
 *
 * @author udoprog
 */
@Slf4j
@ToString
public abstract class Cassandra2BackendBase implements MetricBackend {
    @Inject
    @Named("group")
