...
public class MetricsRowKey {
    ...
    /* public List<DataPoint> buildDataPoints(ColumnList<Integer> result) { final List<DataPoint> datapoints = new
     * ArrayList<DataPoint>();
     * 
     * for (final Column<Integer> column : result) { datapoints.add(new
     * DataPoint(MetricsRowKeySerializer.calculateAbsoluteTimestamp(base, column.getName()), column.getDoubleValue()));
     * }
     * 
     * return datapoints; } */
    ...
    public static long calculateBaseTimestamp(long timestamp) {
