...
public class NextGenSchema extends AbstractCassandraSchema implements Schema {
    ...
    public AsyncFuture<SchemaInstance> instance(Session s) {
        ...
        return async
                .collectAndDiscard(ImmutableList.of(write, fetch, delete, count, keysPagingLimit, keysPagingLeftLimit))
                .directTransform(r -> {
                    return new NextGenSchemaInstance(write.getNow(), fetch.getNow(), delete.getNow(), count.get(),
