...
public class NextGenSchema extends AbstractCassandraSchema implements Schema {
    ...
    public AsyncFuture<SchemaInstance> instance(Session s) {
        ...
        return async.collectAndDiscard(ImmutableList.of(write, fetch, keysPagingLimit, keysPagingLeftLimit))
                .directTransform(r -> {
                    return new NextGenSchemaInstance(write.getNow(), fetch.getNow(), keysPagingLimit.getNow(),
