...
public final class Cassandra2MetricModule implements MetricModule {
    ...
    @JsonCreator
    public static Cassandra2MetricModule create(@JsonProperty("id") String id, @JsonProperty("seeds") String seeds,
        ...
        return new Cassandra2MetricModule(id, group, keyspace, seeds, maxConnectionsPerHost, pools);
    }
