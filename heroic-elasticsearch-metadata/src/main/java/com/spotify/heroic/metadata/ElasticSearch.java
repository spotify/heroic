...
public final class ElasticSearch implements MetadataModule {
    ...
    @JsonCreator
    public static ElasticSearch create(@JsonProperty("id") String id, @JsonProperty("seeds") List<String> seeds,
        ...
        return new ElasticSearch(id, pools, s, clusterName, index, type, nodeClient, writeBulkActions,
