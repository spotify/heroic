...
public class DurationTest {
    ...
    @Test
    public void testShorthandDurationSerializer() throws JsonParseException, JsonMappingException, IOException {
        assertEquals(Duration.of(1, TimeUnit.MILLISECONDS), mapper.readValue("\"1ms\"", Duration.class));
        assertEquals(Duration.of(2, TimeUnit.MILLISECONDS), mapper.readValue("\"2ms\"", Duration.class));
    ...
    @Test
    public void testFallbackDurationSerializer() throws JsonParseException, JsonMappingException, IOException {
