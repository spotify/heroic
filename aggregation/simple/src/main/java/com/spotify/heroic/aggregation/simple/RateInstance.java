...
/**
 * A rate implementation inspired by the prometheus rate() function.
 *
 * It is intended to be be used with counters that are increasing to calculate the difference
 * between two points. It handles the counter being reset.
 *
 * @author dmichel
 */
@Data
public class RateInstance implements AggregationInstance {
