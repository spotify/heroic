...
data class GroupUnique(
    ...
    override fun apply(context: AggregationContext?, size: Long, extent: Long): GroupUniqueInstance {
        return GroupUniqueInstance(size, extent)
    }

    companion object {
        const val NAME = "group-unique"
    }
}
