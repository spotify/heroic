...
data class Count(override var size: Duration?, override var extent: Duration?)
    : SamplingAggregation {
    ...
    override fun apply(context: AggregationContext?, size: Long, extent: Long): CountInstance {
        return CountInstance(size, extent)
    }
