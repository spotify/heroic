...
import com.spotify.heroic.aggregationcache.cassandra.CassandraCache;
...
@JsonSubTypes({ @JsonSubTypes.Type(value = InMemoryAggregationCacheBackend.class, name = "in-memory"),
