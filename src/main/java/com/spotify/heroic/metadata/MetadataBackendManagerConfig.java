...
@Data
public class MetadataBackendManagerConfig {
    private final List<MetadataBackendConfig> backends;

    @JsonCreator
    public static MetadataBackendManagerConfig create(
            @JsonProperty("backends") List<MetadataBackendConfig> backends) {
        return new MetadataBackendManagerConfig(backends);
    }
    ...
    public Module module() {
        return new PrivateModule() {
            @Provides
            @Singleton
            public MetadataBackendManagerReporter reporter(
            ...
            private void bindBackends(
                    final Collection<MetadataBackendConfig> configs) {
