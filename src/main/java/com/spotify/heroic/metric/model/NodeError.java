...
public class NodeError implements RequestError {
    ...
    @JsonCreator
    public static NodeError create(@JsonProperty("nodeId") UUID nodeId, @JsonProperty("nodeUri") URI nodeUri,
    ...
    public static NodeError fromException(final UUID nodeId, final URI nodeUri, final Map<String, String> shard,
            Exception e) {
