...
public class SemanticMetadataBackendReporter implements MetadataBackendReporter {
    ...
    public SemanticMetadataBackendReporter(SemanticMetricRegistry registry, String context) {
        final MetricId id = MetricId.build("metadata-backend").tagged("context", context);
