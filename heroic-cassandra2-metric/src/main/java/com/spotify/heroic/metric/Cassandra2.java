...
import com.spotify.heroic.metric.cassandra2.Cassandra2Backend;
import com.spotify.heroic.statistics.MetricBackendReporter;
import com.spotify.heroic.statistics.MetricManagerReporter;

@Data
public final class Cassandra2 implements MetricModule {
    ...
    @JsonCreator
    public static Cassandra2 create(@JsonProperty("id") String id, @JsonProperty("seeds") String seeds,
        ...
        return new Cassandra2(id, group, keyspace, seeds, maxConnectionsPerHost, pools);
    }
    ...
    public PrivateModule module(final Key<MetricBackend> key, final String id) {
        return new PrivateModule() {
            ...
            protected void configure() {
                bind(key).to(Cassandra2Backend.class).in(Scopes.SINGLETON);
                expose(key);
            }
        };
    }
