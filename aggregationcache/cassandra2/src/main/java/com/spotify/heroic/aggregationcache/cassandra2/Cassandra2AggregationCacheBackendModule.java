...
public class Cassandra2AggregationCacheBackendModule implements AggregationCacheBackendModule {
    ...
    @JsonCreator
    public static Cassandra2AggregationCacheBackendModule create(@JsonProperty("seeds") String seeds,
        ...
        return new Cassandra2AggregationCacheBackendModule(seeds, keyspace, maxConnectionsPerHost, pools);
    }
    ...
    public Module module() {
        return new PrivateModule() {
            ...
            protected void configure() {
                bind(AggregationCacheBackend.class).to(Cassandra2AggregationCacheBackend.class).in(Scopes.SINGLETON);
