...
public final class ElasticSearchMetadataModule implements MetadataModule {
    ...
    @JsonCreator
    public static ElasticSearchMetadataModule create(@JsonProperty("id") String id, @JsonProperty("seeds") List<String> seeds,
        ...
        return new ElasticSearchMetadataModule(id, pools, s, clusterName, index, type, nodeClient, writeBulkActions,
