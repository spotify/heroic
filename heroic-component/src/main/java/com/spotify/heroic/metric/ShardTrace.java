...
public class ShardTrace {
    ...
    @JsonCreator
    public ShardTrace(
        @JsonProperty("shard") final Map<String, String> shard,
    ...
    public static ShardTrace of(
        final Map<String, String> shard, final long latency, final Statistics statistics,
        final Optional<RequestError> error
    ) {
        return new ShardTrace(shard, latency, statistics, error, ImmutableList.of());
    }
}
