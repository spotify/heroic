...
public interface AggregationCacheBackend extends LifeCycle {
     ...
     */
    public Future<CacheBackendGetResult> get(CacheBackendKey key, DateRange range) throws CacheOperationException;
     ...
     */
    public Future<CacheBackendPutResult> put(CacheBackendKey key, List<DataPoint> datapoints)
            throws CacheOperationException;
}
